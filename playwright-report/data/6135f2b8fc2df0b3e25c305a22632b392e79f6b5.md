...
- Name: Работа с корзиной >> Добавление товара в корзину
- Location: C:\saucedemo-e2e-tests\tests\cart.spec.js:13:3

# Error details

```
Error: browserType.launch: Executable doesn't exist at C:\Users\Admin\AppData\Local\ms-playwright\webkit-2158\Playwright.exe
╔═════════════════════════════════════════════════════════════════════════╗
